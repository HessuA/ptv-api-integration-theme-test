 ...
 * @Last Modified time: 2023-12-05 18:42:32
 *
...
add_action( 'after_setup_theme', function() {
  $theme_settings = [
     ...
     */
    'menu_locations' => [
      'primary' => __( 'Primary Menu', 'ptv-api-test' ),
    ],
    ...
    'acf_blocks' => [
      [
        'name'  => 'category-links',
        'title' => 'Kategoriat linkkeinä',
      ],
    ],

    // Custom ACF block default settings
    'acf_block_defaults' => [
      'category'          => 'ptv-api-test',
      'mode'              => 'auto',
      'align'             => 'full',
      'post_types'        => [
        'page',
  ...
  $theme_settings = apply_filters( 'Ptv_api_test_theme_settings', $theme_settings );
