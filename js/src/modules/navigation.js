 ...
 * The original, accessible navigation module for ptv-api-test
 *
...
const navMobile = () => {
  ...
  function navToggle(e) {
    ...
    if (e.type === 'click' || e.keyCode === 13) {
      ...
      if (document.getElementById('nav-toggle').getAttribute('aria-label') === Ptv_api_test_screenReaderText.expand_toggle) {
        // eslint-disable-next-line camelcase, no-undef
        document.getElementById('nav-toggle').setAttribute('aria-label', Ptv_api_test_screenReaderText.collapse_toggle);
      } else {
        // eslint-disable-next-line camelcase, no-undef
        document.getElementById('nav-toggle').setAttribute('aria-label', Ptv_api_test_screenReaderText.expand_toggle);
      }
