      ...
      if (
        ...
        if (thisElement.parentNode.previousElementSibling) {
          ...
          if (previousItem.querySelector('.sub-menu')) {
            ...
            previousItem.querySelector('.dropdown-toggle').setAttribute('aria-label', `${Ptv_api_test_screenReaderText.expand_for} ${previousItem.querySelector('.dropdown-item').innerText}`);
    ...
    addMultipleEventListeners(item, ['click', 'keydown', 'keypress'], (e) => {
      ...
      if (e.key === 'Enter' || e.type === 'click') {
        ...
        if (thisElement.getAttribute('aria-expanded') === 'false') {
          ...
          // eslint-disable-next-line camelcase, no-undef
          thisElement.setAttribute('aria-label', `${Ptv_api_test_screenReaderText.collapse_for} ${linkLabel}`);
        } else {
          ...
          // Set aria-label of the dropdown button
          // eslint-disable-next-line camelcase, no-undef
          thisElement.setAttribute('aria-label', `${Ptv_api_test_screenReaderText.expand_for} ${linkLabel}`);
        }
      ...
      if (e.key === 'Escape') {
        ...
        // eslint-disable-next-line camelcase, no-undef
        dropdownToggleButton.setAttribute('aria-label', `${Ptv_api_test_screenReaderText.expand_for} ${linkLabel}`);
